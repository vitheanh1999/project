...
(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function () {
        ...
        this.$dropdownBtn = $('<a type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-tasks"></i>' + ' ' + this.options.i18n.display + ' </a>');
        this.$dropdownContainer = $('<ul class="dropdown-menu display-check-row"/>');
        ...
        if (this.$btnToolbar[0].childNodes.length >= 3) {
            swap(this.$btnToolbar[0].childNodes[1], this.$btnToolbar[0].childNodes[(this.$btnToolbar[0].childNodes.length - 1)])
        }
